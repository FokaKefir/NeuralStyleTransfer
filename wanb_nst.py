    ...
    if config['optimizer'] == 'adam':
        ...
        for cnt in range(num_of_iterations[config['optimizer']]):
            ...
            with torch.no_grad():
                ...
                utils.save_and_maybe_display(optimizing_img, dump_path, config, cnt, num_of_iterations[config['optimizer']], should_display=False, wandb_log=True)
...
if __name__ == '__main__':
    ...
    for config_t in product(*param_config.values()):
        config = dict(zip(param_config.keys(), config_t))
        ...
        optimization_config['height'] = height
        optimization_config['saving_freq'] = saving_freq

        with wandb.init(project='neural_style_transfer', config=config):
